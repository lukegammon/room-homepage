document.addEventListener( 'DOMContentLoaded', function () {
    ...
    const image1 = document.querySelectorAll(".slide-img1");
    const image2 = document.querySelectorAll(".slide-img2");
    const image3 = document.querySelectorAll(".slide-img3");

    
    
    console.log(image1[0].parentElement.style.background);
    const setDesktop = () => {
        arrows.style.position = "absolute";
        arrows.style.bottom = "1.5rem";
        arrows.style.right = "-8.7rem";
        arrows.style.width = "9.6rem";
        image1.forEach(image => {
            image.parentElement.style.background = "url('./images/desktop-image-hero-1.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
        image2.forEach(image => {
            image.parentElement.style.background = "url('./images/desktop-image-hero-2.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
        image3.forEach(image => {
            image.parentElement.style.background = "url('./images/desktop-image-hero-3.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
    }
    const setMobile = () => {
        ...
        arrows.style.width = "9.6rem";
        image1.forEach(image => {
            image.parentElement.style.background = "url('./images/mobile-image-hero-1.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
        image2.forEach(image => {
            image.parentElement.style.background = "url('./images/mobile-image-hero-2.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
        image3.forEach(image => {
            image.parentElement.style.background = "url('./images/mobile-image-hero-3.jpg')";
            image.parentElement.style.backgroundSize = "cover";
        })
    }
